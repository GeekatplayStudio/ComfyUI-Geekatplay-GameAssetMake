...
class GameAssetPlannerNode:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                ...
                "art_style": (["Dark Fantasy", "Stylized Low Poly", "Realistic PBR", "Cyberpunk", "Sci-Fi", "Hand-Painted Cartoon"], {
    ...
    def plan_assets(self, game_concept_prompt, target_asset_count, art_style, seed, llm_breakdown_json=""):
        ...
        manifest.append({
            ...
            "name": hero_name,
            "category": "hero",
            "prompt": f"full body 3D game character concept model sheet of {hero_name}, {art_style} style, isolated white background, t-pose, front view, clear details",
            "engine_target": "tripo",
            "rig_type": "biped",
        ...
        manifest.append({
            ...
            "name": enemy_type,
            "category": "enemy",
            "prompt": f"full body 3D game monster concept of {enemy_type}, {art_style} style, isolated white background, aggressive stance, detailed texture",
            "engine_target": "tripo",
            "rig_type": "quadruped",
            "include_texture": True,
            "include_rigging": True,
        ...
        while len(manifest) < target_asset_count:
            ...
            manifest.append({
                ...
                "name": f"{p_name} {idx}",
                "category": p_cat,
                "prompt": f"3D game asset concept of {p_name}, {art_style} style, isolated white background, production ready, high quality texture",
